...
<div id="pvmi-add" class="wrap metabox-holder columns-2 pvmi-metaboxes hidden">
	...
	<form class="validate" method="post" name="machine_inspector_add" action="<?php echo esc_url( admin_url( 'admin.php?page=' . $this->plugin_name ) ); ?>">
		...
		<p class="submit">
			<input name="action" value="pvmi_admin_add" type="hidden">
