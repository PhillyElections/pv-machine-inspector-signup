		...
		?>
			<tr>
				...
				<td>
					...
					</form> <a href="<?php echo esc_url( admin_url( 'admin-post.php' ) . '&action=pvmi_admin_delete&action=' . $row->id ); ?>" class="submitdelete" aria-label="Move “Sample Page” to the Trash">Trash</a> | 
				</td>
				<td>
